...
#include "..\ComputerAlgebraSystem\P.h"
#include "..\ComputerAlgebraSystem\Exceptions.h"
...
#pragma endregion
	...
	private: System::Void —охранить»сторию¬ычислений¬‘айлToolStripMenuItem_Click(System::Object ^ sender, System::EventArgs ^ e) {
		if (HISTORY.size()) {
			...
			sfd->DefaultExt = "txt";
			sfd->Filter = "“екстовые документы (*.txt)|*.txt|HTML документы (*.html)|*.html";
			if (sfd->ShowDialog() == System::Windows::Forms::DialogResult::OK) {
				try {
					Stream^ stream = sfd->OpenFile();
					StreamWriter^ sw = gcnew StreamWriter(stream);
					if (sfd->FilterIndex == 1) {
						sw->Write("»стори€ вычислений\r\n");
						...
						sw->Write("\t<h1>»стори€ вычислений</h1>\r\n");
						sw->Write("\t<table border = \"1\" width = \"100%\" cellspacing = \"0\" cellpadding = \"3\" style = \"word-wrap: break-word; table-layout: fixed\">\r\n");
						sw->Write("\t\t<tr>\r\n");
						sw->Write("\t\t\t<td width = \"25%\" align = \"center\"><b>ћодуль</b></td>\r\n");
						sw->Write("\t\t\t<td width = \"25%\" align = \"center\"><b>ѕервый операнд</b></td>\r\n");
						sw->Write("\t\t\t<td width = \"25%\" align = \"center\"><b>¬торой операнд</b></td>\r\n");
						sw->Write("\t\t\t<td width = \"25%\" align = \"center\"><b>–езультат</b></td>\r\n");
						sw->Write("\t\t</tr>\r\n");
						for (size_t i = 0; i < HISTORY.size(); i++) {
							sw->Write("\t\t<tr>\r\n");
